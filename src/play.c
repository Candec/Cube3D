...
/*   Updated: 2023/03/13 12:21:52 by tpereira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	draw_frame(t_mlx *cube)
{
	...
	cube->img_so.img = mlx_xpm_file_to_image(cube->mlx_ptr, "./assets/tile03.xpm", &cube->img_so.img_width, &cube->img_so.img_height);
